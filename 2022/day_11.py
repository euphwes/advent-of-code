...
PART_ONE_DESC = 'monkey business over 20 rounds'
PART_TWO_DESC = 'monkey business over 10,000 rounds with big worry'
...
class Monkey:
    ...
    def inspect_items(self, monkeys, divisor_lcm, is_part_two=False):
        ...
        while self.items:
            ...
            # ... but we can preserve the worry value's divisibility by all the monkeys' test values
            # by taking the worry value mod the LCM (lowest common multiple) of all test values.
            # This will keep the worry value from becoming unresonably large.
            ...
            recipient_monkey = self.true_monkey if divisibility_check_passed else self.false_monkey
...
@aoc_output_formatter(YEAR, DAY, 1, PART_ONE_DESC, assert_answer=72884)
...
@aoc_output_formatter(YEAR, DAY, 2, PART_TWO_DESC, assert_answer=15310845153)

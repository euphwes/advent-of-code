...
PART_ONE_DESC = "positions a 2-knotted rope's tail occupies"
PART_TWO_DESC = "positions a 10-knotted rope's tail occupies"
...
def follow(leading, trailing):
    ...
    if are_neighbors(trailing, leading):
        return trailing
...
def get_tail_positions_of_n_knotted_rope(n, movement_instructions):
    ...
    for line in movement_instructions:
        ...
        for _ in range(amount):
            ...
            for leading_ix in range(0, n-1):
                ...
                knot_positions[trailing_ix] = follow(leading, trailing)
...
@aoc_output_formatter(2022, 9, 1, PART_ONE_DESC, assert_answer=6081)
def part_one(movement_instructions):
    return len(get_tail_positions_of_n_knotted_rope(2, movement_instructions))


@aoc_output_formatter(2022, 9, 2, PART_TWO_DESC, assert_answer=2487)
def part_two(movement_instructions):
    return len(get_tail_positions_of_n_knotted_rope(10, movement_instructions))

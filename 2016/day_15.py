...
PART_ONE_DESCRIPTION = "first time index to get a capsule"
PART_ONE_ANSWER = 317371

PART_TWO_DESCRIPTION = "first time index to get a capsule with new disc"
PART_TWO_ANSWER = 2080951
...
def _will_capsule_pass_through_at_ix(disc_info, ix):
    ...
    for delta in range(1, max(disc_info.keys()) + 1):
        # Grab the disc info, and figure out its current position based on the starting position
        # and how much total time has elapsed.

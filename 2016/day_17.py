...
@aoc_output_formatter(2016, 17, 1, '')
def part_one(passcode):
    ...
    while state_queue:
        ...
        for neighbor, direction in _get_options(curr_state.coord, passcode, curr_state.path):
            state_queue.append(StateGraphNode(coord=neighbor, path=curr_state.path+direction))


@aoc_output_formatter(2016, 17, 2, '')

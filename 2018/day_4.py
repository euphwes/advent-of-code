...
def _parse_guard_sleep_log(guard_info):
    """Parses the problem input and returns a dictionary of guard ID to a list of the minutes
    they were asleep."""
...
def part_one(guard_info):
    ...
    # of minutes slept.
    guard_sleep_min = [
        (guard_id, sleeping) for guard_id, sleeping in guard_sleep_log.items()
    ]
...
def part_two(guard_info):
    ...
    # Hold a list of tuples of (guard_id, minute_slept_most_often,
    # how_many_times_asleep_that_min)

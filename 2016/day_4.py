...
PART_ONE_DESCRIPTION = "sum of sector IDs of real rooms"
PART_ONE_ANSWER = 409147

PART_TWO_DESCRIPTION = "sector ID of room where the North Pole objects are stored"
PART_TWO_ANSWER = 991
...
class DecodedRoom:
    ...
    def is_real_room(self):
        ...
        frequency_to_letter_list.sort(
            key=lambda count_letter: count_letter[0], reverse=True
        )

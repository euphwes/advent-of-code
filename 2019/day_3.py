...
PART_ONE_DESCRIPTION = "Manhattan distance of closest intersection"
PART_ONE_ANSWER = 375

PART_TWO_DESCRIPTION = "Fewest combined steps"
PART_TWO_ANSWER = 14746
...
def run(input_file):
    wire_instructions = get_tokenized_input(input_file, ",")
